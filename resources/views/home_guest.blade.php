...
<section class="max-w-7xl mx-auto py-12 px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
    <div class="flex flex-col items-center text-center bg-gray-100 dark:bg-gray-900 rounded-2xl shadow 
        ...
        <img src="{{ asset('images/icons/easy.png') }}" 
             class="w-12 h-12 mb-4 dark:invert" 
             alt="Simplicité">
    ...
    <div class="flex flex-col items-center text-center bg-gray-100 dark:bg-gray-900 rounded-2xl shadow 
                hover:shadow-lg p-8 transition ring-1 ring-gray-300 dark:ring-gray-700">
        <img src="{{ asset('images/icons/secure.png') }}" 
             class="w-12 h-12 mb-4 dark:invert" 
             alt="Sécurité">
                        ...
                        <div class="aspect-video w-full rounded-xl bg-gray-200 dark:bg-gray-700 overflow-hidden">
                            <div class="aspect-video w-full rounded-xl bg-gray-200 dark:bg-gray-700 overflow-hidden">
                                <img src="{{ $property->image_path 
                                            ? asset('storage/' . $property->image_path)   // images uploadées
                                            : asset('images/properties/default.png') }}"  {{-- fallback --}}
