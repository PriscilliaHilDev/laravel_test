<x-action-section class="bg-white dark:bg-gray-900 rounded-xl shadow-md p-6 border">
    ...
    <x-slot name="content">
            ...
            <div class="mt-5 space-y-6">
                ...
                @foreach ($this->sessions as $session)
                    <div class="flex items-center">
                        ...
                        <div class="ms-3">
                            <div class="text-base  text-gray-800 dark:text-gray-800">
                            ...
                            <div>
                                <div class="text-xs text-gray-400">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-green-400 font-semibold">{{ __('This device') }}</span>
                                    @else
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            <x-slot name="title">
                <span class="text-white">{{ __('Log Out Other Browser Sessions') }}</span>
            </x-slot>
            ...
            <x-slot name="footer">
                ...
                <x-button class="ms-3 bg-indigo-600 hover:bg-indigo-500 text-white"
